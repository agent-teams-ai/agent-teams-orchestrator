...
- the future integration owner selected by OD-034 owns connector installation,
  vendor authentication, webhook cursors, raw dedupe, and reconciliation only
  after event storming and context-map acceptance;
