...
| Access Control | Supporting | Proposed | Context-local projections of membership and grant facts supplied by the configured product authority provider | [Dossier](../domain/contexts/access-control/README.md) |
