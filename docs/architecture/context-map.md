...
| Execution Observation | Supporting | Accepted by ADR-0083 | Admitted runtime evidence, protected diagnostics, deterministic user-facing activity, durable activity feeds, and authorized search | [Dossier](../domain/contexts/execution-observation/README.md) |
