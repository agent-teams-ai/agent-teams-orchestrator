...
project directory or Workspace. It is unrelated to the Run-owned inventory entry
that ADR-0079 provisionally names `RunRuntimeTarget`, which records an opaque AR
target reference.
